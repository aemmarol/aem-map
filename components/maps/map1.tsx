...
import {getSectorData} from "../../pages/api/v1/db/sectorCrud";
...
export const Map1: FC = () => {
  ...
  function sectorColor(sectorName: string) {
    const [primaryColor, setPrimaryColor] = useState("");
    useEffect(() => {
      try {
        getSectorData(sectorName).then((data) => {
